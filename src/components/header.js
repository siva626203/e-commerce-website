  ...
  <Container>
    ...
    <Navbar.Collapse id="basic-navbar-nav">
      <Nav className="me-auto">
        ...
        <Nav.Link as={Link} to="/e-commerce-website" className="dropdown"><AiFillHome className='icon'/>Home</Nav.Link>
        ...
        <Nav.Link as={Link} to="/register" className="dropdown"><ImEnter className='icon-m'/>Register</Nav.Link>
        <Nav.Link as={Link} to="/login" className="dropdown"><MdOutlineLogin className='icon-m'/>Login</Nav.Link>
      </Nav>
    </Navbar.Collapse>
  </Container>
</Navbar>
